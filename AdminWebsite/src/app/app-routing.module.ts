...
import {DogComponent} from './DemoPages/UserPages/dog/dog.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'dog', component: DogComponent, data: {extraParameter: ''}},
  ...
  },
  {
    ...
    children: [
      ...
      {path: 'pages/register', component: RegisterBoxedComponent, data: {extraParameter: ''}},
      {path: 'forgotpassword', component: ForgotPasswordBoxedComponent, data: {extraParameter: ''}},
